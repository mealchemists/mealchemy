...
steps_1 = [
    ...
    {
        "step_number": "2",
        "description": "Overhead of stir-fry ingredients in various bowls. \
    ...
    {
        "step_number": "3",
        "description": "Overhead of chopped vegatables, beef, and seseme seeds being cooked together in a wok. \
                                        Dotdash Meredith Food Studios\
                                        Serve hot and enjoy!",
    },
]
...
steps_2 = [
    {
        "step_number": "1",
        "description": "Preheat grill for medium heat and lightly oil the grate. Gather ingredients.",
    },
    {
        "step_number": "2",
        "description": "Four raw, bone-in pork chops on a baking sheet with 4 small bowls of ingredients on the side Whisk ketchup, honey, soy sauce, and garlic together in a bowl to make a glaze.",
    },
    {
        "step_number": "3",
        "description": "Overhead view of brown sauce inside of a clear glass bowl and a hand with a whisk stirring said sauce Sear the pork chops on both sides on the preheated grill. Lightly brush glaze onto each side of the chops as they cook; grill until no longer pink in the center, about 7 to 9 minutes per side. An instant-read thermometer inserted into the center should read 145 degrees F (63 degrees C).",
    },
    {
        "step_number": "4",
        "description": "Overhead view of 4 pork chops on a griddle. Brush with sauce on the surface of one of the pork chops.Serve hot and enjoy!",
    },
]
...
recipe_data = [
    {
        ...
        "ingredients": ingredients_data_1,
        "steps": steps_1,
    },
    {
        "name": "Honey Garlic Pork Chops",
        "main_ingredient": "pork",
        "ingredients": ingredients_data_2,
        "steps": steps_2,
    },
]
...
def create_users():
    users = []
    user = User.objects.create_user(username="demo@email.com", password="password$")
    users.append(user)
    print(users)
...
def create_meal_plans():
    ...
    for _ in range(3):
        ...
        meal_plan = MealPlan.objects.create(
            day_planned=random_day, meal_type=meal_type, recipe=recipe
        )
