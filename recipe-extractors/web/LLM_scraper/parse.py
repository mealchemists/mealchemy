...
def join_steps(data):
    ...
    if 'steps' in data:
        ...
        data['recipe']['steps'] = joined_steps  # Replace the list of steps with the joined string
        del data['steps']
    return data
...
def transform_dict_keys(data):
    if isinstance(data, dict):  # If the data is a dictionary
        return {replace_separators_with_underscore(key): transform_dict_keys(value) for key, value in data.items()}
